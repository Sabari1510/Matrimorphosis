...
// import { User } from '../../models/models'; // Models doesn't define User interface yet, likely user explicitly defines it here or uses any.
// Let's use any for now to avoid errors, or define User in models.ts.
// Since User model in backend exists, frontend should probably have one.
// Step 247 shows models.ts has MaintenanceRequest but not User.
// I will just use 'any' or define it locally to satisfy compilation.
